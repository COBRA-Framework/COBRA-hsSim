...
import pt.ul.fc.di.lasige.simhs.core.domain.scheduling.policies.McNSchedulingPolicy;
 ...
 *
 */
public class McNScheduler extends MultiprocessorGlobalScheduler implements IFJPScheduler {
	...
	protected SchedulingPolicy getPolicy() {
		return new McNSchedulingPolicy();
	}
